const ruRU: { [name: string]: string } = {
    ...
    'STR_TITLE_EDITOR_ACTION_RENAME': 'Переимен.',
    ...
    'STR_SPEED_NORMAL': 'Нормальная скорость',
    'STR_SPEED_QUICK': 'Бысто',
    'STR_SPEED_FAST': 'Ещё быстрее',
    'STR_SPEED_TURBO': 'Турбоскорость',
    'STR_SPEED_HYPER': 'Гиперскорость',
