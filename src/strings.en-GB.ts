const enGB: { [name: string]: string } = {
    ...
    'STR_TITLE_EDITOR_COMMAND_TYPE_VISIBILITY': 'Visibility',
    'STR_TITLE_EDITOR_COMMAND_TYPE_SPEED': 'Speed',
    'STR_TITLE_EDITOR_COMMAND_TYPE_FOLLOW': 'Follow Sprite',
    'STR_TITLE_EDITOR_COMMAND_TYPE_RANDOM': 'Follow Random',
    ...
    'STR_TITLE_EDITOR_ARGUMENT_RANDOM': 'Entity type:',
    'STR_TITLE_EDITOR_ARGUMENT_SCROLL_VIEWPORT': 'Scroll view',
    ...
    'STR_RANDOM_VEHICLE': 'Random Vehicle',
    'STR_RANDOM_GUEST': 'Random Guest',
    'STR_RANDOM_STAFF': 'Random Staff',
