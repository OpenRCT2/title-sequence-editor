const itIT: { [name: string]: string } = {
    ...
    'STR_TITLE_SEQUENCE': 'Sequenza del titolo:',
    ...
    'STR_TITLE_EDITOR_ACTION_DELETE': 'Elimina',
    'STR_TITLE_EDITOR_ACTION_DELETE_SEQUENCE_TIP': 'Delete the current title sequence',
    'STR_TITLE_EDITOR_ACTION_RENAME': 'Rinomina',
    ...
    'STR_TITLE_EDITOR_ACTION_INSERT': 'Inserisci',
    ...
    'STR_TITLE_EDITOR_END': 'Fine',
    'STR_TITLE_COMMAND_EDITOR_ACTION_GET_LOCATION': 'Get',
    'STR_TITLE_COMMAND_EDITOR_ACTION_SELECT_SCENARIO': 'Seleziona',
    'STR_SPEED_NORMAL': 'Velocità normale',
    'STR_SPEED_QUICK': 'Veloce',
    'STR_SPEED_FAST': 'Molto veloce',
    'STR_SPEED_TURBO': 'Super veloce',
    'STR_SPEED_HYPER': 'Estremamente veloce',
