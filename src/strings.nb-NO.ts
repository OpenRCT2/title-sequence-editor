const nbNO: { [name: string]: string } = {
    ...
    'STR_OK': 'OK',
    'STR_CANCEL': 'Avbryt',
    'STR_TITLE_COMMAND_EDITOR_SELECT_SPRITE': 'Velg sprite',
    'STR_TITLE_COMMAND_EDITOR_COMMAND_LABEL': 'Command:',
    'STR_TITLE_COMMAND_EDITOR_TITLE': 'Command Editor',
    'STR_TITLE_EDITOR_ACTION_LOAD_SAVE': 'Last inn lagret spill',
    'STR_TITLE_EDITOR_ARGUMENT_SAVEFILE': 'Save to load:',
    'STR_TITLE_EDITOR_ACTION_LOAD_SCENARIO': 'Last inn scenario',
    'STR_TITLE_EDITOR_ARGUMENT_SCENARIO': 'Scenario å laste:',
    ...
    'STR_TITLE_EDITOR_ARGUMENT_WAIT_SECONDS': 'Tid i millisekunder:',
    ...
    'STR_TITLE_COMMAND_EDITOR_NO_SCENARIO_SELECTED': 'Ingen scenario valgt',
